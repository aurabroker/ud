...
PROFESSIONS = [
    ...
    ("komornik", "Komornik", "prawo"),
    ("sedzia", "Sędzia", "prawo"),
    ("prokurator", "Prokurator", "prawo"),
    ("prawnik", "Prawnik", "prawo"),
    ("adwokat-aplikant", "Aplikant Adwokacki", "prawo"),
    ("notariusz-aplikant", "Aplikant Notarialny", "prawo"),
    # MEDYCYNA
    ...
    ("medycyna-rodzinna", "Lekarz Rodzinny", "medycyna"),
