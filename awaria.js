...
(function () {
  ...
  function wstrzyknijStyle() {
    ...
    s.textContent = [
      ...
      'justify-content:center;padding:16px;font-family:Inter,system-ui,-apple-system,"Segoe UI",Roboto,sans-serif}',
      '#' + ID + ' .ud-aw-tlo{position:absolute;inset:0;background:rgba(15,23,42,.75);backdrop-filter:blur(4px)}',
      '#' + ID + ' .ud-aw-okno{position:relative;background:#fff;border-radius:16px;padding:28px 24px;',
      'max-width:420px;width:100%;box-shadow:0 25px 50px -12px rgba(0,0,0,.45);text-align:center;',
      'max-height:90vh;overflow-y:auto;box-sizing:border-box}',
      '#' + ID + ' .ud-aw-ikona{width:60px;height:60px;border-radius:9999px;background:#fee2e2;color:#dc2626;',
      'font-size:28px;font-weight:700;line-height:60px;margin:0 auto 16px}',
      '#' + ID + ' h2{margin:0 0 8px;font-size:20px;font-weight:800;color:#0f172a}',
      '#' + ID + ' p{margin:0 0 20px;font-size:14px;line-height:1.6;color:#475569}',
      '#' + ID + ' .ud-aw-tel{display:flex;align-items:center;justify-content:center;gap:8px;',
      'background:#2563eb;color:#fff;text-decoration:none;font-weight:800;font-size:19px;',
      'padding:14px 16px;border-radius:12px;margin-bottom:10px}',
      '#' + ID + ' .ud-aw-tel:hover{background:#1d4ed8}',
      '#' + ID + ' .ud-aw-zglos{display:block;width:100%;box-sizing:border-box;background:#f1f5f9;color:#0f172a;',
      'text-decoration:none;font-weight:700;font-size:14px;padding:11px 16px;border-radius:12px;margin-bottom:8px}',
      '#' + ID + ' .ud-aw-zglos:hover{background:#e2e8f0}',
      '#' + ID + ' .ud-aw-zamknij{display:block;width:100%;background:none;border:0;color:#64748b;',
      'font-size:13px;padding:8px;cursor:pointer;font-family:inherit}',
      '#' + ID + ' .ud-aw-zamknij:hover{color:#0f172a}',
      '#' + ID + ' details{margin-top:14px;text-align:left}',
      '#' + ID + ' summary{font-size:12px;color:#64748b;cursor:pointer}',
      '#' + ID + ' pre{margin:8px 0 0;background:#f8fafc;border:1px solid #e2e8f0;border-radius:8px;',
      'padding:10px;font-size:11px;line-height:1.5;color:#334155;white-space:pre-wrap;word-break:break-word}',
      '#' + ID + ' .ud-aw-kopiuj{margin-top:8px;background:none;border:0;color:#2563eb;font-size:12px;',
